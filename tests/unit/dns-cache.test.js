...
import { DnsCache } from '../../src/lib/dns-cache.js';
describe('DnsCache', () => {
    let cache;
    beforeEach(() => {
        cache = new DnsCache();
    ...
    describe('キャッシュ無効化', () => {
        beforeEach(() => {
            ...
            const testData = [
                ...
                { domain: 'example.com', type: 'AAAA', value: '2001:db8::1' },
                { domain: 'test.com', type: 'A', value: '192.0.2.2' },
                { domain: 'test.com', type: 'MX', value: 'mail.test.com' }
            ];
            ...
            const exportData = [
                {
                    ...
                    entry: {
                        response: {
                            query: { domain: 'import-test.com', type: 'A' },
                            records: [{ type: 'A', value: '192.0.2.1' }],
                            responseTime: 100,
                            status: 'success'
                        },
            ...
            const exportData = [
                {
                    ...
                    entry: {
                        response: {
                            query: { domain: 'expired.com', type: 'A' },
                            records: [{ type: 'A', value: '192.0.2.1' }],
                            responseTime: 100,
                            status: 'success'
                        },
...
//# sourceMappingURL=dns-cache.test.js.map