...
describe('CloudflareClient', () => {
    ...
    describe('constructor', () => {
        ...
        it('無効な設定でエラー', () => {
            ...
            }).toThrow('API token or email/apiKey is required');
        });
    });
    describe('listZones', () => {
        ...
        it('名前フィルターを適用', async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining('name=test.com'), expect.any(Object));
        });
    ...
    describe('listDNSRecords', () => {
        ...
        it('フィルターオプションを適用', async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining('content=192.0.2.1'), expect.any(Object));
        });
    });
