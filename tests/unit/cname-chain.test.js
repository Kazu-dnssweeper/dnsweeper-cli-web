...
import { traceCnameChain, validateCnameChain, getCnameChainStats, traceMultipleCnameChains } from '../../src/utils/cname-chain.js';
// DNS モジュールをモック
vi.mock('node:dns', () => ({
    promises: {
        resolveCname: vi.fn()
...
//# sourceMappingURL=cname-chain.test.js.map